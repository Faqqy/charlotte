...
<?php } ?>
 <div class="panel panel-default">
  <div class="list-group">
    ...
    <a id="click__item" class="list-group-item"><?php echo $filter_group['name']; ?> <span class="text-right">+</span> </a>
    <div id="open_list" class="list-group-item">
      <div id="filter-group<?php echo $filter_group['filter_group_id']; ?>">
        ...
        <?php } ?>
          <button type="button" id="button-filter" class="text-right button-cart">Применить</button>
      </div>
    </div>
    <?php } ?>
