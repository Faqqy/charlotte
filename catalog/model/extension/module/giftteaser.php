<?php
class ModelExtensionModuleGiftTeaser extends Model {
    private $moduleName;
	...
	public function updateGiftsInCart($key = null) {
		$setting = $this->getSetting($this->moduleName, $this->config->get('config_store_id'));
		if(isset($setting[$this->moduleName]['Enabled']) && $setting[$this->moduleName]['Enabled'] == 'yes') {
	...
	public function checkGifts() {
          ...
          if (empty($giftTeaser[$this->moduleName]['Enabled']) || $giftTeaser[$this->moduleName]['Enabled'] == 'no') { 
