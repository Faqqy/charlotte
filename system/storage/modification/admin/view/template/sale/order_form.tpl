        ...
        <form class="form-horizontal">
          ...
          <div class="tab-content">
            ...
            <div class="tab-pane" id="tab-cart">
		  	...
		  	<input type="hidden" name="product[<?php echo $product_row; ?>][gift_teaser]" id="product[<?php echo $product_row; ?>][gift_teaser]" value="<?php echo $order_product['gift_teaser']; ?>" />
	...
	$.ajax({
		...
		success: function(json) {
			...
			if (json['error']) {
		  	...
		  	data: $('#cart input[name^=\'product\'][type=\'hidden\'],#cart input[name^=\'product\'][type=\'text\'], #cart input[name^=\'product\'][type=\'hidden\'], #cart input[name^=\'product\'][type=\'radio\']:checked, #cart input[name^=\'product\'][type=\'checkbox\']:checked, #cart select[name^=\'product\'], #cart textarea[name^=\'product\']'),
