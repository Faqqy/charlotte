<div id="cart" class="btn-group btn-block">
  				...
  				<button type="button" data-toggle="dropdown" data-loading-text="" class="btn btn-inverse btn-block btn-lg dropdown-toggle"><img src="catalog/view/theme/charlotte/image/icons/cart.png"><?php if ($count > 0) { ?><span class="count"><?php echo $count; ?></span><?php } ?><?php if ($count === null) { ?><span class="count">0<?php } ?></button>
